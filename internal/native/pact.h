 ...
 */
bool pactffi_add_interaction_reference(InteractionHandle interaction,
                                       const char *group,
                                       const char *name,
                                       const char *value);
 ...
 */
void pactffi_verifier_set_follow_redirects(struct VerifierHandle *handle, unsigned char follow);
