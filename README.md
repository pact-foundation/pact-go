...
See [CONTRIBUTING](https://github.com/pact-foundation/pact-go/blob/master/.github/CONTRIBUTING.md). Maintainers cutting a release should see [RELEASING](RELEASING.md).
